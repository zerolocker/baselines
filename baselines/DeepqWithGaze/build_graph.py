...
def build_act(make_obs_ph, q_func, num_actions, scope="DeepqWithGaze", reuse=None):
...
def build_act_with_param_noise(make_obs_ph, q_func, num_actions, scope="DeepqWithGaze", reuse=None, param_noise_filter_func=None):
